...
_config: Virtualized[CachingAutotuner] = Virtualized("config", NullHandler)
_tiling1: Virtualized[SIMDScheduling] = Virtualized("tiling", NullHandler)
_tiling2: Virtualized[SIMDScheduling] = Virtualized("tiling", NullHandler)
...
class _V:
    ...
    #youngsu define
    set_config_info: Callable[[CachingAutotuner], ] = _config._set_handler
    set_tiling_info1: Callable[[SIMDScheduling], ] = _tiling1._set_handler
    set_tiling_info2: Callable[[SIMDScheduling], ] = _tiling2._set_handler
    @property
    ...
    #youngsu define
    @property
    def config(self) -> CachingAutotuner:
        """The configuration currently being generated"""
        return _config._get_handler()
    
    @property
    def tiling1(self) -> SIMDScheduling:
        """The configuration currently being generated"""
        return _tiling1._get_handler()
    
    @property
    def tiling2(self) -> SIMDScheduling:
        """The configuration currently being generated"""
        return _tiling2._get_handler()
